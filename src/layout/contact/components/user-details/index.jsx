          ...
          <div>
            ...
            >
              <MagneticButton
                variant='outline'
                size='md'
                className='w-full border-muted-foreground !text-sm [&>span]:inline-flex [&>span]:!max-w-none [&>span]:items-center [&>span]:gap-2 [&>span]:!whitespace-nowrap [&>span]:!break-normal'
              >
                <svg
                  aria-hidden='true'
                  viewBox='0 0 24 24'
