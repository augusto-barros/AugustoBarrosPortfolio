...
export function Services() {
    ...
    const services = [
        ...
        },
        {
            id: '02',
            title: 'Development',
            description: 'I build scalable websites from scratch that fit seamlessly with design. My focus is on micro animations, transitions and interaction. Building with React and Next.js.',
        },
        {
            id: '03',
    ...
    return (
        <section
            ref={container}
            className='text-text w-full px-10 py-24 md:px-20'
        >
