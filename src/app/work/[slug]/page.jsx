                ...
                <main className="min-h-screen pt-40 md:pt-60">
                    ...
                    <div className="mx-auto mb-20 max-w-[1400px] px-4 md:px-10">
                        <div className="grid grid-cols-1 gap-10 border-t border-black/10 pt-6 md:grid-cols-3">
                            <div>
                                <span className="mb-4 block text-xs uppercase tracking-wider text-black/50">Role / Services</span>
                                <div className="border-t border-black/10 pt-4">
                                    <p>{project.roleServices}</p>
                                </div>
                            </div>
                            <div>
                                <span className="mb-4 block text-xs uppercase tracking-wider text-black/50">Credits</span>
                                <div className="border-t border-black/10 pt-4">
                            ...
                            <div>
                                <span className="mb-4 block text-xs uppercase tracking-wider text-black/50">Location & Year</span>
                                <div className="border-t border-black/10 pt-4">
                    ...
                    <section className="w-full">
                        {project.galleryImages?.map((img, i) => (
                            <div key={i} className="relative h-[60vh] w-full overflow-hidden md:h-screen">
                                <ClientImage
                                    src={img}
                    ...
                    {project.nextProject && (
                        <section className="relative flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden bg-[#1c1d20] py-32 text-center text-white md:py-48">
                            <Link href={`/work/${project.nextProject.slug}`} className="z-10 flex w-full flex-col items-center justify-center">
                                <p className="mb-6 text-sm uppercase tracking-wider text-white/50">Next case</p>
