export const workDetails = {
    'appcaloria': {
        ...
        location: 'Brasil',
        year: '2026',
        quote: 'A revolutionary approach to tracking your daily caloric intake with artificial intelligence.',
        description: 'AppCaloria is an innovative mobile application designed to simplify the process of monitoring your diet. By leveraging advanced machine learning, it accurately estimates nutritional information from photos, providing users with a seamless and intuitive experience. Our focus was to build a robust, scalable backend paired with a beautiful, fast, and accessible frontend.',
        galleryImages: [
